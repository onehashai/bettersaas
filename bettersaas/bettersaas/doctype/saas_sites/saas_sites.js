...
frappe.ui.form.on("SaaS sites", {
  refresh: async function (frm) {
    frm.add_custom_button(__('Restore Site'), function(){
          frappe.confirm(__("This action will restore this saas-site. Are you sure ?"), function() {
            frappe.call({
              "method": "bettersaas.bettersaas.doctype.saas_sites.saas_sites.restore_site",
              args: {
